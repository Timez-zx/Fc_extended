...
if __name__ == "__main__":
  ...
  ax.plot(x , ksp_tagger2_throughputs, marker='s', lw=2, label='KSP_T2')
  ax.plot(x , ksp_tagger3_throughputs, marker='<', color='greenyellow', lw=2, label='KSP_T3')
  ax.plot(x , ksp_throughputs, marker='*', color='r',lw=2, label='KSP')
  ax.plot(x , up_down_ksp_throughputs, marker='h', color='c', lw=2, label='KSP-UD')
  ax.plot(x , edge_disjoin_throughputs, marker='o', color='darkorange',lw=2, label='EDGE DIS')
  ax.plot(x , equal_cost_clos, marker='x', color='mediumpurple', lw=2, label='CLOS')
